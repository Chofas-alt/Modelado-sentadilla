...
function [po0,po1,po2,po3]=pierna_izquierda(K0,q,l)
hold on
%arriba cadera esfera, rodilla cilindro, ellipsoide tobillo  6GDL cada uno
% Matrices de transformación homogénea
A01=rotz(-q(1))*roty(-q(2))*rotx(-q(3))*trasl(0,0,-l(2));% rotacion interna negativo,q2 abduccionq negativo,flexion negativo  
A12=rotx(-q(4))*trasl(0,0,-l(3));%flexion rodilla negativo
A23=roty(-q(5))*rotx(-q(6))*trasl(0,0,-l(4));%abduccion negativo, flexion negativo
% Cadenas cinemáticas
K1=K0*A01;
K2=K1*A12;
K3=K2*A23;
